...
<div>
            <table class="table table-hover" style="width: 650px;">                     
                <tr>
                    <td>수령인</td>
                    <td>
                        <input type="text" name="address_recipent" maxlength="20" class="form-control" placeholder="수령인을 입력해주세요.">
                    </td>
                </tr>                
                <tr>
                    <td>휴대폰 번호</td>
                    <td>
                        <input class="form-control" type="text" name="address_phone" maxlength="13" placeholder="-없이 번호만 입력해주세요" >
                    </td>
                </tr>
                <tr>                 
 					<td>배송지 주소</td>
					<td>
						<input type="text" class="form-control" style="display: inline-block; width: 80%;" id="sample4_postcode" placeholder="우편번호" maxlength="10" readonly name="address_1">
						<input type="button" onclick="sample4_execDaumPostcode()" value="검색" class="btn btn-outline-secondary"><br><br>
						<input type="text" class="form-control" id="sample4_roadAddress" placeholder="도로명,지번주소" maxlength="30" size="30" name="address_2" readonly><br>
                        <input type="hidden" id="sample4_jibunAddress" placeholder="지번주소"  size="30">
						<span id="guide" style="color:#999;display:none"></span>
						<input type="text" class="form-control" id="sample4_detailAddress" placeholder="상세주소"  size="30" name="address_3" maxlength="40" ><br>
				...
				<tr>
					<td>요청 사항</td>
					<td>
						<input class="form-control" name="address_request" type="text" size="50" placeholder="택배 기사님께 전달할 메시지를 남겨주세요." />
					</td>
				</tr>
               </table>
	</div>          
	<button type="button" onclick="checkAddress()" class="btn btn-outline-dark">등록</button>
	&nbsp;
