	...
	<div class="container">
		<div class="col" style="text-align: left;">
           <ul  class="sideMenu">
            ...
            <li class="sideMenu2"><a href="${contextPath}/manager/getOrderList.do"><font <c:if test="${orderList != null ||  orderMap != null || refundList != null}">class="active"</c:if> style="color: B2B2B2;">주문 관리</font></a><li>
